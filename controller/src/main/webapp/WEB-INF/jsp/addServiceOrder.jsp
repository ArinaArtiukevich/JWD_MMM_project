...
<html>
    <head>
        ...
        <fmt:message bundle="${loc}" key="button.add.order" var="button_add_order"/>
    </head>
    <body>
        ...
        <div class="container">
            ...
            <fieldset class="row mb-3" name="gender">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <input checked="checked" class="form-check-input" type="radio" name="service_type"
                               id="electricalRadios" value="electrical"/>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="service_type" id="roofingRadios"
                               value="roofing"/>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="service_type" id="paintingRadios"
                               value="painting"/>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="service_type" id="plumbingRadios"
                               value="plumbing"/>
            ...
            <button type="submit" class="btn btn-light">${button_add_order}</button>
        </div>
